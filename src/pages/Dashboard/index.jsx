...
import { ticketSummaryCard, tickets, recentActivityTickets } from "../../Components/Dashboard/mokeDB";
    ...
    <Layout
      ...
      children={
        <Col className={cn("position-relative", "p-0")} style={{ backgroundColor: "var(--bs-gray-100)" }}>
          ...
          {recentActivityShow && <RecentActivityBlock recentActivity={recentActivity} recentActivityShow={recentActivityShow} setRecentActivityShow={setRecentActivityShow} />}
        </Col>
      }
    />
  );
