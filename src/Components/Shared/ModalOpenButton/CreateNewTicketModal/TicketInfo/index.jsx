...
export default function TicketInfo({ activeStep, onCancel, onNext, setTicketTitle, setTicketType, ticketTitle, ticketType, priority, setPriority, resetFilledData }) {
      ...
      <Formik initialValues={initialValues} validationSchema={validationSchema} onSubmit={handleSubmit}>
        {(formik) => (
          <Form noValidate onSubmit={formik.handleSubmit} className='d-flex flex-column flex-grow-1'>
            <BodyTicketInfo activeStep={activeStep} formik={formik} priority={priority} setPriority={setPriority} resetFilledData={resetFilledData} />
            <FooterWithTwoButtons primaryButtonTitle='Next' secondaryButtonTitle='Cancel' secondaryButtonClick={onCancel} type='submit' />
          </Form>
        )}
      </Formik>
    </>
